...
5. **shopping_list.md** - Upgrade recommendations at different budget tiers
...
**shopping_list.md Template:**
```markdown
# Shopping List: [Cube Name] Upgrades

**Current Cube:** Built from existing collection
**Upgrade Goal:** Optimize for [cube strategy/goals]

## Budget Tier 1: Essential Upgrades ($20-30)
Cards that provide the biggest impact per dollar:

1. **[Card Name]** - ~$X
   - Why: [Clear reasoning for impact]
   - Role: [What slot it fills/improves]
   - Action: ADD/SWAP for [card name]

## Budget Tier 2: High Value ($50-75)
Additional upgrades for significant improvement:

[2-4 more cards with same format]
...
## Where to Buy
- **CardKingdom.com** - Single order, reliable
- **TCGPlayer.com** - Often cheaper, multiple sellers

## Notes
- Prices as of [date]
- All recommendations respect cube constraints
...
cubes/
  cube_name/
    ...
    SHOPPING_LIST.md    # Upgrade recommendations at budget tiers
```
